...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      const loadingMessage = await api.sendMessage("loading aesthetic anime vdo, please wait...", event.threadID);

      const pageId = "animeaesthetic2"; // Replace with the ID or username of the Facebook page ("naos011" in this case)
      const accessToken = "EAAD6V";// add your token
