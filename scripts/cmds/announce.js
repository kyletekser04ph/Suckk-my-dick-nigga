...
module.exports = {
	...
	langs: {
		...
		en: {
			...
			notification: "┏━━━𝗔𝗡𝗡𝗢𝗨𝗡𝗖𝗘𝗠𝗘𝗡𝗧━━━┓\n\n",
			sendingNotification: "Start sending 𝗔𝗡𝗡𝗢𝗨𝗡𝗖𝗘𝗠𝗘𝗡𝗧 from admin bot to %1 chat groups",
			sentNotification: "✅ Sent 𝗔𝗡𝗡𝗢𝗨𝗡𝗖𝗘𝗠𝗘𝗡𝗧 to %1 groups successfully",
	...
	onStart: async function ({ message, api, event, args, commandName, envCommands, threadsData, getLang }) {
		...
		const formSend = {
			body: `${getLang("notification")}👑 𝗙𝗿𝗼𝗺 𝗕𝗼𝘁 𝗢𝘄𝗻𝗲𝗿:\n\n${args.join(" ")}`,
