...
module.exports = {
  config: {
    name: "help",
    version: "1.17",
    author: "siam", // original author Siam 
    countDown: 5,
    role: 0,
    shortDescription: {
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      const helpListImages = [
        "https://i.ibb.co/fDsmBZh/image.jpg", // add image link here
        "https://i.ibb.co/nPgyXRD/image.jpg",
        "https://i.ibb.co/gRHqwJW/image.jpg",
        "https://i.ibb.co/pxKrBXR/image.jpg",
        "https://i.ibb.co/rbq8MjS/image.jpg",
